...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { bank_id: @point.bank_id, flag: @point.flag, hour: @point.hour } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { bank_id: @point.bank_id, flag: @point.flag, hour: @point.hour } }
